...
int main(int argc, char** argv){
  ...
  // Copiar al GPU
  cudaMemcpy2D(Image_R, or_size, Matrix_R, sizeof(unsigned char)*Num_Cols,
               sizeof(unsigned char)*Num_Cols, Num_Rows, cudaMemcpyHostToDevice);

  cudaMemcpy2D(Image_G, or_size, Matrix_G, sizeof(unsigned char)*Num_Cols,
               sizeof(unsigned char)*Num_Cols, Num_Rows, cudaMemcpyHostToDevice);

  cudaMemcpy2D(Image_B, or_size, Matrix_B, sizeof(unsigned char)*Num_Cols,
               sizeof(unsigned char)*Num_Cols, Num_Rows, cudaMemcpyHostToDevice);

  cudaMemcpy2D(Image_R_bk, or_size, Matrix_R, sizeof(unsigned char)*Num_Cols,
               sizeof(unsigned char)*Num_Cols, Num_Rows, cudaMemcpyHostToDevice);

  cudaMemcpy2D(Image_G_bk, or_size, Matrix_G, sizeof(unsigned char)*Num_Cols,
               sizeof(unsigned char)*Num_Cols, Num_Rows, cudaMemcpyHostToDevice);

  cudaMemcpy2D(Image_B_bk, or_size, Matrix_B, sizeof(unsigned char)*Num_Cols,
               sizeof(unsigned char)*Num_Cols, Num_Rows, cudaMemcpyHostToDevice);
